...
namespace Qth
{
	...
	void WatchObjectFilterDlg::initUI()
	{
		...
		titleWidget->setFixedHeight(25);
		{
			...
			d->_btnCheckAll->setText("CheckAll");
			d->_btnCheckAll->setFixedSize(Common::getContentWidth(d->_btnCheckAll->font(), d->_btnCheckAll->text()).width() + 20, 20);

			d->_btnCheckSelected = new QPushButton(titleWidget);
			d->_btnCheckSelected->setText("CheckSelected");
			d->_btnCheckSelected->setFixedSize(Common::getContentWidth(d->_btnCheckSelected->font(), d->_btnCheckSelected->text()).width() + 20, 20);

			d->_btnReset = new QPushButton(titleWidget);
			d->_btnReset->setText("Reset");
			d->_btnReset->setFixedSize(Common::getContentWidth(d->_btnReset->font(), d->_btnReset->text()).width() + 20, 20);
	...
	QWidget* WatchObjectFilterDlg::initTypeList()
	{
		...
		QMetaEnum me = QtEnumUtils::getMetaEnum(QEvent::None);
